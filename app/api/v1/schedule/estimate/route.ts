...
export async function POST(request: NextRequest) {
  ...
  const load=await liveKitchenLoad(),result = calculateSchedule(body, await drinkWorkMinutes(), load.activeFoodOrders,load.activeMicrowaveSeconds,load.fryerPreheated);
