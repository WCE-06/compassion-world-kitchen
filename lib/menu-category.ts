...
export function normalizedMenuCategory(name:string,current?:string){
  ...
  if(/コーラ|ジュース|ソーダ|ラムネ|サイダー|ウーロン|緑茶|ほうじ茶|麦茶|ミルク|ドリンク|ウォーター|お茶/.test(text))return"soft-simple";
